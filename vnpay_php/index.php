...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/BWD_2023_CenterGym/assets/css/payment.css" />
    </head>
<style>
    .hide {
  display: none; 
    ...
    <body>
      ...
      <form  action="./vnpay_create_payment.php" id="create_form" method="post" class="form">  
      <div class="form-group hide">
                    ...
                    <div class="form-group hide" style="margin: auto; width: fit-content;"> <label for="amount">Số tiền</label> <input class="form-control" id="amount" name="amount" type="number" value="10600000"/> </div>
                    <div class="form-group hide">
                    ...
                    <button type="submit" name="redirect" id="redirect" class="btn btn-default hide" >
Xác nhận</button>
        <div class="input-box">
          <label>Full Name</label>
          <input type="text" name="ten" placeholder="Enter full name" required />
        </div>
    ...
    <div class="gender">
      ...
      <label for="check-other">Prefer not to say</label>
        ...
        <div class="groupbutton">
          <button><a href="../chinhsachgia.html">Back</a></button>
          <button  type="submit" name="redirect" id="redirect">Submit</button>
        </div>
